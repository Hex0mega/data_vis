...
<?php include_once($_SERVER["DOCUMENT_ROOT"]."/nav/nav.php");?>
  ...
  <body>
    ...
    $proxies[] = '213.80.130.210:80';  // Some proxies require user, password, IP and port number
    ...
    curl_setopt($ch, CURLOPT_URL, 'https://www.streetinsider.com/ec_earnings.php?q=AAPL');
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true); 	// return web page
    curl_setopt($ch, CURLOPT_HEADER, true); 	//return headers in addition to content
